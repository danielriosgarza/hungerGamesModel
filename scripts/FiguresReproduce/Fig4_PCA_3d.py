# -*- coding: utf-8 -*-
"""
Created on Wed Mar 19 14:41:45 2025
...
steadstate_pHfeed_ambr_8 = (description == 'post pH/feed perturbation') & (ambr_8) & (timeCond>99) 
...
tax.scatter(control_composition,
            s=250,
            marker='o', 
            color='#00FF00', 
            label="control",
...
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures',
                        'multistability', 'ambr_path', 'ternary_control.png')
...
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures',
                        'multistability', 'ambr_path', 'ternary_feed.png')
...
# Scatter plot the data
tax.scatter(pHfeed_composition,
            s=250,
            marker = 's', 
            color='#FFD700', 
            label="pH + feed pert.",
...
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures',
                        'multistability', 'ambr_path', 'ternary_pHfeed.png')
...
# Set the background (pane) colors for each axis (RGB + alpha)
...
control_time = ax.scatter(x_pc[idx_control], 
                          y_pc[idx_control],
                          marker = 'o',
                          c = timeCond[idx_control],
                          cmap = 'Purples',
                          s = 500,
                          vmin = 0,
                          vmax = 120)
...
control_data = ax.scatter(x_pc[idx_control], 
                          y_pc[idx_control],
                          edgecolors='k',
                          linewidths=0.5,
                          c='#00FF00', 
...
# Save the figure
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures',
                        'multistability', 'ambr_path', 'pca_control.png')
...
feed_time = ax.scatter(x_pc[feed], 
                          y_pc[feed],
                          c = timeCond[feed],
                          marker = 'o',
                          cmap = 'Purples',
...
feed_data = ax.scatter(x_pc[feed], 
                          y_pc[feed],
                          edgecolors='k',
                          linewidths=0.5,
                          marker = '^',
...
# Save the figure
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures',
                        'multistability', 'ambr_path', 'pca_control_feed.png')
fig.patch.set_alpha(0)
plt.savefig(fileName, dpi=600, transparent = False)
plt.show()
...
pHfeed_time = ax.scatter(x_pc[pHfeed], 
                          y_pc[pHfeed],
                          c = timeCond[pHfeed],
                          marker = 'o',
                          cmap = 'Purples',
...
pHfeed_data = ax.scatter(x_pc[pHfeed], 
                          y_pc[pHfeed],
                          edgecolors='k',
                          linewidths=0.5,
                          marker = 's',
...
# Save the figure
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures',
                        'multistability', 'ambr_path', 'pca_control_pHfeed.png')
