...
def makeSimulation(pHControl = None, 
    ...
    if perturbation:
        batchA = Pulse(wc_feed, feed_microbiome, 0, 2400, 100, 0, 0, dilutionRate,dilutionRate)

        batchB = Pulse(wc_feed, feed_microbiome, 2400, 2640, 100, 0, 0, 0, 0)

        batchC = Pulse(wc_feed, feed_microbiome, 2640, 5040, 100, 0, 0, dilutionRate,dilutionRate)
...
dilution_values = np.linspace(0, 3, 150)/15
