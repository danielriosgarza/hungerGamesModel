...
def makeSimulation(pHControl = None, 
    ...
    if perturbation:
        batchA = Pulse(wc_feed, feed_microbiome, 0, 600, 100, 0, 0, dilutionRate,dilutionRate)

        batchB = Pulse(wc_feed, feed_microbiome, 600, 5040, 100, 0, 0, dilutionRate,dilutionRate)
        ...
        batchA = Pulse(wc_feed, feed_microbiome, 0, 5040, 100, 0, 0, dilutionRate,dilutionRate)
...
pH_points = np.linspace(5,6.5,150)
...
pH_values = np.linspace(5,6.5,150)
