...
batchB = Pulse(wc_feed, feed_microbiome, 2400, 2640, 100, 0, 0, d2,d2)
...
reactorB = Reactor(reactorA.microbiome, wc_reactor,[
...
reactorC = Reactor(reactorB.microbiome, wc_reactor,[
                                                  batchC
