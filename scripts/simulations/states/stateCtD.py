...
fixedpHA = mockpHfunc(wc.metabolites,pH=5.50)
...
batchA = Pulse(wc_feed, feed_microbiome, 0, 3000, 100, 0, 0, d,d)

batchB = Pulse(wc_feed, feed_microbiome, 3000, 3200, 100, 0, 0, d2,d2)

batchC = Pulse(wc_feed, feed_microbiome, 3200, 6000, 100, 0, 0, d,d)
...
reactorB = Reactor(reactorA.microbiome, wc_reactorB,[
