...
batchB = Pulse(wc_feed, feed_microbiome, 600, 1000, 100, 0, 0, d2,d2)

batchC = Pulse(wc_feed, feed_microbiome, 1000, 3000, 100, 0, 0, d,d)
...
reactorB = Reactor(reactorA.microbiome, wc_reactorC,[
...
reactorC = Reactor(reactorB.microbiome, wc_reactorC,[
                                                  batchC
